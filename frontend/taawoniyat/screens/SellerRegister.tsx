...
//   handleRegister: (userData: Omit<SellerRegisterData, 'confirmPassword'>) => Promise<void>;
//   registerData: SellerRegisterData;
//   setRegisterData: React.Dispatch<React.SetStateAction<SellerRegisterData>>;
// }

// const SellerRegister: React.FC<SellerRegisterProps> = ({
//   isLoading,
//   setIsLoading,
//   setIsLogin,
//   handleRegister,
...
//     const userData: Omit<SellerRegisterData, 'confirmPassword'> = {
...
//       <Text style={styles.subtitle}>Join us today as a Seller</Text>
...
//           onChangeText={(text) => setRegisterData((prev) => ({ ...prev, businessName: text }))}
//           editable={!isLoading}
//         />
//       </View>
//       <View style={styles.inputContainer}>
...
//         disabled={isLoading}
//       >
//         {isLoading ? <ActivityIndicator color="white" /> : <Text style={styles.primaryButtonText}>Register as Seller</Text>}
//       </TouchableOpacity>
